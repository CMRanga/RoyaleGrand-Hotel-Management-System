...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Royal Grand - Hotel & Restaurant</title>  
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="overflow-hidden">
						<h4>Location</h4>
						<p class="lead">
							Royal Grand Hotel, Kelimune, Kurunegala
						</p>
					</div>
				</div>
			</div>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>The Royal Grand Hotel is a modern, elegant 4-star hotel , perfect for a romantic, charming vacation, in the enchanting setting of Kurunegala district.</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Royal Grand Hotel, Kelimune, Kurunegala</p>
					<p class="lead"><a href="#">+94 372 236 932</a></p>
					<p><a href="#"> admin@royalgrand.lk</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Subscribe</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">All Rights Reserved. &copy; 2022 <a href="#">Royal Grand Hotel & Restaurant </a> Design By : CSC3232 - Group 4 
					</p>
					</div>
				</div>
			</div>
